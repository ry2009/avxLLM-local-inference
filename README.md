...
- `make run-infer`, `make run-train`, `make run-pretrain`, `make run-eval`, `make run-pipeline`, `make run-telemetry`, `make run-manifest` — invoke the helper scripts described above.
